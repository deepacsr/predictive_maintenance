...
CoolantPressure = st.number_input("Coolant Pressure", min_value=0.0024, max_value=7472, value=2.33, step =0.1)
LubricantOilTemp = st.number_input("Lubricant Oil Temp", min_value=71.3, max_value=89.58, value=77.64, step =1)
CoolantTemp = st.number_input("Coolant Temp", min_value=61.67, max_value=195.52, value=78.42, step =1)
